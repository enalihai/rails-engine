module Parameterable
  def valid_query?(params)
    if params[:name] == nil && params[:min_price] == nil && params[:max_price] == nil
      ...
      return false
    elsif params[:min_price] != nil && params[:max_price] != nil && params[:min_price].to_f > params[:max_price].to_f
      return false
    elsif params[:min_price] != nil && params[:min_price].to_f < 0
      return false
    elsif params[:max_price] != nil && params[:max_price].to_f < 0
      return false
    else
      return true
    end
